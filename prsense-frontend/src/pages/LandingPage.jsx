...
export default function LandingPage() {
  ...
  const mockReviewComments = {
    review: [
      { agent: "Security Scanner", code: `- const STRIPE_KEY = "sk_test_51Nz...";`, comment: "🚨 Leak: Do not commit active credentials. Use environment configurations or vault stosemantic searche.", type: "err" },
