...
export default function ReviewTimeline() {
  ...
  const defaultGanttTrace = [
    ...
    { node: "semantic search_retriever", name: "Semantic Context Retrieval", start: 15, duration: 320, tokens: 1850, cost: 0.00028, color: "from-yellow-500 to-amber-500", inputs: { query: " SOLID principles, naming conventions", limit: 5 }, outputs: { matchedRulesCount: 4, avesemantic searcheSimilarity: "0.89" } },
  ...
  // Calculate stats
  const avesemantic searcheDuration = timeline.length > 0 
